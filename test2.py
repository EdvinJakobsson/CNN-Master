...
for essayset in essaysets:
    ...
    essayfolder = "Results/essayset" + str(essayset[0])
    ...
    for model_number in model_numbers:
        ...
        dropout_values.write("essayset: " + str(essayset[0]) + " \t \t epochs: " + str(numbers_of_kappa_measurements*epochs_between_kappa) + " \t \t k-fold: no \t \t batch size: 10 \t\t layers: 2 \t \t output: " + str(output) + " \r \r")
            ...
            for dense in dense_numbers:
                ...
                for kernel_length in kernel_length_number:
                    ...
                    for kernels in kernel_numbers:
                        ...
                        path = dropoutfolder + "Images/dense" + str(dense) + "kernels" + str(kernels) + "kernellength" + str(kernel_length)
                        os.makedirs(path)
